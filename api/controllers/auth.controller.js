...
export const signin = async (req, res, next) => {
  ...
  try {
    ...
    ); //whatever we add this is going to be encrypted and create a token for us it's like hashing a password. this encrypted value cannot be read normally. and save this encrypted value to the cookie of the browser and then we are going to use it later to authenticate the user
